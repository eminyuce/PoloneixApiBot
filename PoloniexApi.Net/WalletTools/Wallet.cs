...
namespace Jojatekok.PoloniexAPI.WalletTools
{
    public class Wallet : IWallet
    {
        ...
        public Balance2 GetBalances2()
        {
            var postData = new Dictionary<string, object>();

            var data = PostData<Balance2>("returnCompleteBalances", postData);
            return data;
        }

        public Task<Balance2> GetBalances2Async()
        {
            return Task.Factory.StartNew(() => GetBalances2());
        }
    }
}
